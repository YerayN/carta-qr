...
class Carta(models.Model):
    ...
    negocio = models.ForeignKey(Negocio, on_delete=models.CASCADE, related_name="cartas")
...
class Categoria(models.Model):
    carta = models.ForeignKey(Carta, on_delete=models.CASCADE, related_name="categorias")
...
class CategoriaTraduccion(models.Model):
    categoria = models.ForeignKey(Categoria, on_delete=models.CASCADE, related_name="traducciones")
    idioma = models.CharField(max_length=10)
    nombre = models.CharField(max_length=200)

    class Meta:
        constraints = [
            models.UniqueConstraint(fields=["categoria", "idioma"], name="unique_categoria_idioma")
        ]
...
class PlatoTraduccion(models.Model):
    plato = models.ForeignKey(Plato, on_delete=models.CASCADE, related_name="traducciones")
    idioma = models.CharField(max_length=10)
    nombre = models.CharField(max_length=200)
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=["plato", "idioma"], name="unique_plato_idioma")
        ]
